    ...
    return (
        <Container className="d-flex justify-content-center align-items-center mt-4" style={{ background: "#B7ADBE" }}>
            <Row className='m-1'>
                ...
                <Col xs={12} sm={6}>
                    <Image className="" style={{ width: '100%', maxWidth: '100%' }} src={image_13} />
                </Col>

                <Col xs={12} sm={6}>
                    <Image className="" style={{ width: '100%', maxWidth: '100%' }} src={image_12} />
                </Col>
            </Row>
            <Row className='m-1'>
                <Col xs={12} sm={6} className="text-center">
                    <Image className="" style={{ width: '100%', maxWidth: '100%' }} src={image_14} />
                </Col>
                <Col xs={12} sm={6}>
                    <Image className="" style={{ width: '100%', maxWidth: '100%' }} src={image_15} />
                </Col>
            </Row>
        </Container>
