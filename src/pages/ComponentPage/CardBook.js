        ...
        <Container className="">
            <Row sm={6} className="d-none d-sm-flex">
                <Col sm={6} className="col-centered d-flex justify-content-center align-items-center">
                    <Image className="mt-2" src={`http://localhost:8080/book/public/read/file/${id}`} style={{ width: 200, height: 300 }} />
                </Col>
            ...
            <Row sx={12} className="d-flex d-sm-none">
                <Col className="col-centered d-flex ">
                    <Col>
                        <Image className="flex-column " src={`http://localhost:8080/book/public/read/file/${id}`} style={{ width: 100, height: 170 }} />
                    </Col>
